...
##
    for ball in list_of_balls:    
        ...
        if (checkcollision (mother_ball, list_of_balls[3])== True):
            list_of_balls[3].velocity_x +=5
        if (checkcollision (mother_ball, list_of_balls[4])== True):
            list_of_balls[4].velocity_x +=5
        if (checkcollision (mother_ball, list_of_balls[5])== True):
            list_of_balls[5].velocity_x +=5
